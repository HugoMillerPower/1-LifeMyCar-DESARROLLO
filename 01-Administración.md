...
| 10.0.018     | Pruebas: Theme: Activamos Listable <strong>Padre</strong> |Hugo Miller|27/12/2016|
| 10.0.017     | Grupo Tartiere: Theme: Activamos Listable <strong>Hijo/Child</strong>. |Hugo Miller|27/12/2016|
| 10.0.016     | Grupo Tartiere: Apariencia: Personalizar: Theme options: Demo Data: Import Demo Data |Hugo Miller|27/12/2016|
...
| 10.0.012     | LifeMyCar: Apariencia: Personalizar: Theme options: Demo Data: Import Demo Data |Hugo Miller|27/12/2016|
| 10.0.011     | LifeMyCar: Plugin: Instalación y activación de Plugins asociados al Theme Listable, propuestos una vez que está activado:</br></br>- Customify 1.3.1</br>- PixTypes 1.4.4</br>- WP Job Manager 1.25.2</br>- Category Icon 0.6.0</br>- Comments Ratings 1.1.5</br>- Login with Ajax 3.1.6</br>- Nav Menu Roles 1.8.6</br>- WooCommerce 2.6.10 |Hugo Miller|27/12/2016|
| 10.0.010     | LifeMyCar: Theme: Activamos Listable <strong>Padre</strong> |Hugo Miller|27/12/2016|
| 10.0.009    | Theme: Borrado de los themes que no se van a usar: 2015, 2016... .</br>NOTA: El theme 2017 no se puede borrar en ningún caso porque ha sido el theme activo por defecto para WordPress (ver paso 10.0.022).  |Hugo Miller|27/12/2016|
| 10.0.008    | Theme: Instalación y <strong>activación para la red</strong> del theme Listable Hijo/Child.</br>NOTA: así se anula el paso 10.0.007, pero tiene que ser así porque si no , cuando importemos los Demo Data -10.0.011- dará un error de PHP.  |Hugo Miller|27/12/2016|
...
| 10.0.003    | IMPORTANTE: Usuarios: ahora es cuando hay que eliminar el primer usuario creado, en virtud de 6.0.067. Para poder borrarlo, necesitamos crear antes otros usuarios. Creación de los usuarios "Hugo", "José Manuel", "Soporte", todos ellos con perfiles de "SuperAdministradores".   |Hugo Miller|27/12/2016|
...
| 9.0.004   | Sitios: Creación de los sitios (Child) "tartiere.lifemycar.com" y "pruebas.lifemycar.com" además del sitio (Parent) "www.lifemycar.com". |Hugo Miller |26/12/2016| 
