...
|:------------- |:---------------|:---------------|:---------------|
| 10.001.024    | Sitios/Media: Administrador de la red: Sitios (clic en el nombre de cada sitio) (clic en Grupo Tartiere): Información: Dirección del sitio (URL): https://pruebas.lifemycar.com/. Es decir, si el dominio Parent es https, los Child no pueden ser http. Por ejemplo, si no se hace este cambio, no se pueden subir archivos a la galera de Media.|Hugo Miller|27/12/2016|
