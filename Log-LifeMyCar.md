...
|:------------- |:---------------|:---------------|:---------------
| 8.0.002    | Tenemos una instalación normal de WordPress => Hay que pasarla a Multisite. Para ellos trabajaremos con un software de FTP (Coda, en nuestro caso):</br></br>- Borrar el archivo public_html/wp-config-sample.php</br>- Editar el archivo public_html/wp-config.php , añadiendo la línea...</br>define ('WP_ALLOW_MULTISITE', true);</br>... justo antes de la línea (ya presente en el archivo)...</br>/* That's all, stop editing! Happy blogging. */</br>NOTA: ¿Qué hemos ganado al añadir esa instrucción? Pues si vamos al Menú HERRAMIENTAS, ahora aparece una opción que antes no estaba, CONFIGURACIÓN DE LA RED.</br>- CONFIGURACIÓN DE LA RED: escogemos la opción SUBDOMINIOS</br>- CONFIGURACIÓN DE LA RED: Título de la red: Sitios de LifeMyCar</br>- Correo: soporte@lifemycar.com</br>- Seguimos las instrucciones en pantalla para editar el archivo public_html/wp-config.php</br>- Seguimos las instrucciones en pantalla para editar el archivo .htaccess  |Hugo Miller|22/12/2016|
