...
|:------------- |:---------------|:---------------|:---------------
| 8.0.004    | Usuarios + Seguridad: Borrado del primer usuario y se añaden a sopporte y hugo como Súper Administradores del MU. Se cumple con la condición de seguridad planteada en 6.0.067 y 8.0.001. |José Manuel|23/12/2016|
