...
|:------------- |:---------------|:---------------|:---------------
| 8.0.002    | Tenemos una instalación normal de WordPress => Hay que pasarla a Multisite. Para ellos trabajaremos con un FTP (Coda, en nuestro caso):</br></br>- Borrar el archivo public_html/wp-config-sample.php</br>-  |Hugo Miller|22/12/2016|
