...
|:------------- |:---------------|:---------------|:---------------
| 8.0.002    | Tenemos una instalación normal de WordPress => Hay que pasarla a Multisite. Para ellos trabajaremos con un software de FTP (Coda, en nuestro caso):</br></br>- Borrar el archivo public_html/wp-config-sample.php</br>- Ediotar el archivo public_html/wp-config.php , añadiendo la línea...</br>define ('WP_ALLOW_MULTISITE', true);</br>...justo antes de la línea (ya presente en el archivo)...</br>/* That's all, stop editing! Happy blogging. */</br>-  |Hugo Miller|22/12/2016|
