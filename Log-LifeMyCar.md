...
|:------------- |:---------------|:---------------|:---------------|
| 6.0.096    | Plugin: UpdraftPlus Backup/Restore 1.12.29:</br></br>- Programación de Copias de seguridad: 1 copia diaria, guardando las últimas 8 unidades</br>- Programación de Copias de seguridad de la Base de Datos: 2 copias diarias, guardando las últimas 16 unidades</br>- Seleción de un almacenamiento externo => Google Drive (seguir esta página de Ayuda: https://updraftplus.com/support/configuring-google-drive-api-access-in-updraftplus/ ); se han generado estos datos:</br>- Cliente de OAuth
+ ID cliente: 1095009698030-0kkj11gnus1b3kde7r7jg4fn9vb787fu.apps.googleusercontent.com
+ Secreto de cliente: PMgl1ZtpNDHI0ACBwMPNuR4S |José Manuel|14/12/2016|
