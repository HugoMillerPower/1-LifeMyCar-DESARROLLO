...
|:------------- |:---------------|:---------------|:---------------|
| 6.0.098    | Plugin: Hide My WP 5.1.2: IDS Firewall: Blocked Countries Code: Rusia (RU; hijos de Putin) e Indonesia (ID).|José Manuel|16/12/2016|
| 6.0.097    | Plugin: Instalación y activación de Above The Fold Optimization 2.6.17. Sirve para tratar de alcanzar una puntuación de 100 en Google PageSpeed.|José Manuel|16/12/2016|
